...
//Schleife (Loop) über alle Kombninationen Booleschen Werten.
for (let i = 0; i < combinations.length; i++) {
    let tripel = combinations[i];

//html = html + makeTestReport(...):append html to the exising html

html += makeReport(tripel[0], tripel[1], tripel[2]);
}

// Schreibe den Output in das <p> tag.
writeOutput(html);

function makeReport(a,b,c){
...
let html = line(); // Empty line. This is the same as html = html + line ();
